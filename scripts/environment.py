...
from belief_structs import Action, AliasStore, ContinuousBelief, Observation
...
class TampuraEnv:
    ...
    def vis_updated_belief(self, belief: ContinuousBelief, store: AliasStore):
    ...
    def initialize(self) -> Tuple[ContinuousBelief, AliasStore]:
    ...
    def step(self, action: Action, belief: ContinuousBelief, store: AliasStore) -> Observation:
